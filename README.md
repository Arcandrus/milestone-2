...
|Resetting the high scores|A button in the high scores window will allow the user to reset the local high score values.|Clicking the reset button within the high score modal|Working as Intended|
